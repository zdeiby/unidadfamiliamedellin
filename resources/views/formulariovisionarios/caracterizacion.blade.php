...
@csrf
        ...
        <!-- INFORMACION USUARIO-->
            ...
            <div class="col-md-6 text-center" >
                    <label for="validationServer04" id="adjuntar"  class="form-label" >Documento:</label>
                    @if (($url_cedula  != ''))
                    ...
                    <button type="button" id="documentoadjuntodiv" class="btn btn-primary btn-sm" style="background:#663398 !important; border:none" data-bs-toggle="modal" data-bs-target="#modalSubirDocumentoPDF">
                    Adjuntar Documento
                </button>
                    @endif
                    <br>
            ...
            <div class="col-md-6">
                    <label for="validationServer04" class="form-label">Teléfono1:</label>
            ...
            <div class="col-md-4">
                    <label for="validationServer04" class="form-label">Teléfono2:</label>
                    <input type="number" class="form-control form-control-sm" 
          ...
          <div class="col-md-4" id="documentodiv" >
            ...
            <div class="col-md-6" id="ocultarserviciosdiv">
            <label for="validationServer04" id="adjuntarCuenta" class="form-label">Documento Servicios públicos:</label>
            ...
            <button type="button" id="serviciosadjuntodiv" style="background:#663398 !important; display:none" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalSubirCuentaPDF">
                    Adjuntar Cuenta de servicios
                </button>
            @endif
            <br>
                <!-- Botón para abrir el modal de subir documento PDF -->
            ...
            <div class="" id="direccion_actualdiv" style="display:none">
          ...
          <div class="row">       
            ...
            <div class="form-group col-sm">
                ...
                <input type="text" class="form-control form-control-sm" id="dirCampo2" name="dirCampo2" style="text-transform: uppercase;"  onkeypress="return soloNumeros(event)" oninput="llenarotrocampo();" value="{{$dirCampo2}}">
            </div>
            <div class="form-group col-sm">
        ...
        <br>
            ...
            <div class="col-md-4" style="display:none">
                ...
                <select class="form-control form-control-sm" id="tiene_hijos" name="tiene_hijos" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalSubirDocumentoPDFLabel">Subir Documento</h5>
...
<div class="modal fade" id="modalSubirCuentaPDF" tabindex="-1" aria-labelledby="modalSubirCuentaPDFLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalSubirDocumentoPDFLabel">Subir Cuenta de servicios</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="global">
                        ...
                        acuerdo con lo previsto y en aplicación de lo señalado en los artículos 53(1), 56(2) y el numeral 1° del 
                        artículo 67(3) de la Ley 1437 de 2011 - Código de Procedimiento Administrativo y de lo Contencioso 
                        Administrativo, manifiesto que <b>SI    AUTORIZO y ACEPTO</b> expresamente ser notificado(a) por medio electrónico, 
                        de los actos y decisiones administrativas que se profieran dentro de la convocatoria / postulación / 
                        que surtan dentro de la actuación administrativa respectiva que adelante la Agencia de Educación 
                        Postsecundaria de Medellín-SAPIENCIA
                        Teniendo en cuenta que he aceptado la notificación electrónica, para el efecto dispongo del siguiente 
                        correo electrónico, para notificaciones:
            <br><br>

            Aceptación de la autorización: Declaro haber leído, entendido y aceptado la totalidad de los términos y condiciones 
            previamente establecidas, eximiendo de responsabilidad a la Agencia de Educación Postsecundaria de Medellín-SAPIENCIA
            <br>
            Para efectos de la aplicación del artículo 56 del Código de Procedimiento Administrativo y de lo Contencioso 
            Administrativo, se entenderá que al acceder al acto o actuación administrativo me entiendo notificado(a) 
            personalmente del mismo, en la fecha y hora en que reciba el correo electrónico remitido, en el
             buzón de la dirección electrónica indicada en el presente documento. El envío de los actos 
             administrativos al correo electrónico tendrá las mismas consecuencias de la notificación personal 
             prevista en el Código de Procedimiento Administrativo y de lo Contencioso Administrativo.
              Los términos procesales para efectos de la presentación de descargos, interposición de recursos,
               manifestaciones de interés ante la Agencia de Educación Postsecundaria-SAPIENCIA 
               empezarán a conforme a la Ley 1437 de 2011.
                            <br>
...
$('#pais_residencia').change(function(){
    if($('#pais_residencia').val() != '1'){
        ...
        $('#direccion_actualdiv').hide();
        $('#dirCampo2').removeAttr('required');
        $('#dirCampo5').removeAttr('required');
        $('#dirCampo8').removeAttr('required'); 
        $('#dirCampo1').removeAttr('required'); 
...
$('#municipio_residencia').change(function(){
    if($('#municipio_residencia').val() != '1'){
        ...
        $('#dirCampo1').val(20);
        $('#dirCampo9').val('No APLICA VIVE EN OTRO PAIS');      
        ...
        $('#direccion_actualdiv').show();
        $('#dirCampo1').val('');
        $('#dirCampo1').attr('required','required');
        $('#dirCampo9').val('');   
...
$('#fecha_nacimiento').change(function(){
    if($('#edad').val() <= '17'){
       ...
       // $('#comuna_residencia').removeAttr('required');
        ...
        $('#correo_tutor').val('NOAPLICA@NOAPLICA.COM');
...
function guardarFormulario(event) {
   ...
   /* let documentosAdjuntos = 0;
    let municipio =  $('#municipio_residencia').val();
    try {
        ...
        if ((!urlCedula || !urlServicios) && municipio == 1) {
...
console.log('antes de entrar')
        if ($('#municipio_residencia').val() != '1' && ('<?= $municipio_residencia ?>' != '1')) {
            console.log('entrando a 1' , '<?= $municipio_residencia ?>')
                $('#direccion_actualdiv').hide();
                $('#dirCampo2').removeAttr('required');
                $('#dirCampo5').removeAttr('required');
                $('#dirCampo8').removeAttr('required'); 
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.file) {
                            ...
                            $('#documentoadjuntodiv').css('display','none');
                        }
                    },
                    error: function(xhr) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.file) {
                            ...
                            $('#serviciosadjuntodiv').css('display','none');
                        }
                    },
                    error: function(xhr) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const identidadGeneroPorSexo = {
        ...
        3: [1,4, 2, 5, 3] // Intersexual -> Mujer Cis, Hombre Cis, Mujer Trans, Hombre Trans
    };
