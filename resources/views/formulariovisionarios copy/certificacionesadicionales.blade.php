...
@csrf
        ...
        <div class="row g-3 was-validated"> 
            ...
            <div class="col-md-6" id="nivel_educativodiv">
                <label for="nivel_educativo" class="form-label">Nivel educativo alcanzado</label>
                <select class="form-control form-control-sm" id="nivel_educativo" name="nivel_educativo" required>
            ...
            <div class="col-md-6 text-center" >
                ...
                <button type="button" class="btn btn-primary btn-sm" style="background:#663398 !important; border:none" data-bs-toggle="modal" data-bs-target="#modalSubirDocumentoPDF">
                    Adjuntar diploma o certificado PDF
                </button>
            </div>

            <div class="col-md-6" id="estudiandodiv">
                <label for="estudiando" class="form-label">¿Actualmente está estudiando?</label>
                <select class="form-control form-control-sm" id="estudiando" name="estudiando" required>
                    {!! str_replace('value="'.$estudiando.'"', 'value="'.$estudiando.'" selected', $t1_sino) !!}
                </select>
            </div>

            <div class="col-md-6" id="nombre_colegiodiv" style="display:none">
            ...
            <div class="col-md-6" id="grado_cursadodiv" style="display:none">
            ...
            <div class="col-md-6" id="nombre_universidaddiv" style="display:none">
            ...
            <div class="col-md-6" id="programa_academicodiv" style="display:none">
            ...
            <div class="col-md-6" id="semestrediv" style="display:none">
            ...
            <div class="col-md-6" id="titulo_pregradodiv" style="display:none">
            ...
            <div class="col-md-12" id="titulo_posgradodiv" style="display:none">
